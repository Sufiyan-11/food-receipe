...
const Contact = () => {
  const handleFormSubmit = async (values, actions) => {
    ...
    try {
      await axios.post(
        `https://food-receipe-dashboard-default-rtdb.firebaseio.com`,
        values
      );
      actions.resetForm();
          ...
          <Row>
              ...
              >
                {(formik) => (
                  <Form method="post">
                    ...
                    <Button
                      variant="light"
                      className="rounded-pill learnbtn"
                      type="submit"
            ...
            <Col lg="6" sm="12">
              ...
              <div>
                ...
                <small>2130 Fulton Street, San Diego, CA 94117-1080 USA</small>
              </div>
              <br />
              <span>
                <img src={phone} alt="phone" /> <small>1-800-1234-567</small>
              </span>
              <br />
              <br />
              <span>
